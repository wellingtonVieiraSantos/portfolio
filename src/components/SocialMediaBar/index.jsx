...
const SocialMediaBar = () => {
  return (
    <div className='w-[calc(100vw-40px)] md:w-[calc(100vw-80px)] flex items-center justify-end
      text-slate-100 text-xl self-end gap-6 py-4 px-4 backdrop-blur-sm sticky top-0 sm:text-3xl'>
